...
Go through all the stages of the realistic data analysis project, following step-by-step guidelines. Answer specific questions with appropriate methods to draw correct conclusions from the data. Complete the analysis by building the predictive linear model and evaluating in on out-of-sample observations. See the [project description](requirements/info5_capstone.md) for more details.
...
library(kableExtra) # cutomized tables
```
